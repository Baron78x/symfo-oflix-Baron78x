 ...
 * 
 * /!\ Pour gérer les events de type LifeCycleCallbacks
 * @link https://symfony.com/doc/current/doctrine/events.html#doctrine-lifecycle-callbacks
 * @ORM\HasLifecycleCallbacks()
 * 
 * Contrainte côté "application Symfony" (et pas côté MySQL)
...
class Movie
{
     ...
     * @Groups({"movies_get_item"})
     * 
     * @link https://www.doctrine-project.org/projects/doctrine-orm/en/2.11/tutorials/ordered-associations.html
     */
    private $castings;
    ...
    {
        // Pour définir une date par défaut
    ...
    public function addSeason(Season $season): self
    {
        if (!$this->seasons->contains($season)) {
            $this->seasons[] = $season;
            // On en profite pour informer l'entité qui détient la relation
            // on pourra donc utiliser $movie->addSeason($season) soit $season->setMovie($movie)
            // pour associer nos entités
